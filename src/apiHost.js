...
export const apiHost = {
    ...
    AUTH_HOST: 'https://ac2-api.zhgcloud.com',
    ...
    // CO_HOST: 'http://127.0.0.1',
    // TEST_HOST: 'http://127.0.0.1',
    PR_HOST: "https://pr-i.gongchengbing.com",
    RESOURCES_HOST: 'https://resources.zhgcloud.com',
    LOGIN_HOST: 'https://login-api.zhgcloud.com',
    BaiduTransformUrl: `https://api.map.baidu.com/geoconv/v1/?coords=lng,lat&from=1&to=5&ak=${BaiduAk}`,
};
